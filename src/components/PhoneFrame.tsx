 ...
 * device frame on a soft warm gray surround.
 */
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ background: "#2A2622" }}>
      {/* Mobile: full viewport */}
      <div className="md:hidden relative w-screen min-h-screen overflow-hidden" style={{ background: "var(--color-paper)" }}>
        {children}
      </div>
