...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "An honest tool for building a daily Bible reading habit." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://lectio.live" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a2740ce8-e253-4921-a469-fc942302b882" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lectio — A daily Bible reading habit" },
      { name: "twitter:description", content: "An honest tool for building a daily Bible reading habit." },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a2740ce8-e253-4921-a469-fc942302b882" },
    ],
    links: [
